...
export type PaseoHub = {
    ...
    asset: IAsset;
    extensions: PaseoHubExtensions;
    getMetadata: () => Promise<Uint8Array>;
    genesis: string | undefined;
};
declare const _allDescriptors: PaseoHub;
export default _allDescriptors;
export type PaseoHubApis = ApisFromDef<IRuntimeCalls>;
export type PaseoHubQueries = QueryFromPalletsDef<PalletsTypedef>;
export type PaseoHubCalls = TxFromPalletsDef<PalletsTypedef>;
export type PaseoHubEvents = EventsFromPalletsDef<PalletsTypedef>;
