...
import type { LogEntry } from '@/src/lib/sdk/types'
    ...
    <Card className="flex flex-col h-full">
      <CardHeader className="flex flex-row items-center justify-between space-y-0">
        ...
        <div className="flex gap-2">
          <Button variant="ghost" size="sm" onClick={onExport} disabled={logs.length === 0}>
              ...
              {logs.map((entry) => (
                ...
                >
                  <div className="flex items-start gap-2 flex-wrap">
                    ...
                    <span className="text-info font-medium">[{entry.action}]</span>
                  </div>
