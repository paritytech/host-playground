---
name: staff-reviewer
description: Use BEFORE implementation when reviewing a plan, design doc, or architecture proposal. Acts as a skeptical staff engineer looking for problems before code is written. Distinct from review-pr (which is post-implementation).
model: opus
